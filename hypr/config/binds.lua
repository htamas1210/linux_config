...
-- Audio
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+ && swayosd-client --output-volume +0"), { locked = true, repeating = true })
...
-- Brightness
hl.bind("XF86MonBrightnessUp",   hl.dsp.exec_cmd("brightnessctl -n5 set 5%+ && swayosd-client --brightness +0"),   { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl -n5 set 5%- && swayosd-client --brightness -0"), { locked = true, repeating = true })
